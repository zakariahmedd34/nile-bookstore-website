...
Revision ID: 03f646dd0a3c
Revises: 
Create Date: 2025-12-01 16:22:23.584496
...
def upgrade():
    ...
    sa.Column('street_3', sa.String(length=255), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('order_status', sa.Enum('Pending', 'Shipped', 'Delivered', name='order_status_enum'), nullable=False),
    sa.Column('total_amount', sa.Float(), nullable=False),
    sa.Column('order_date', sa.DateTime(), nullable=True),
    sa.Column('payment_method', sa.Enum('Cash', 'Visa', 'Mastercard', name='payment_method_enum'), nullable=False),
    ...
    sa.Column('payment_method', sa.Enum('Visa', 'Mastercard', 'Wallet', 'Fawry', 'ValU', name='payment_method_enum'), nullable=False),
